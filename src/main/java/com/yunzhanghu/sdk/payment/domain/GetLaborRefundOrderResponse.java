...
// 查询劳动者退款订单信息返回
public class GetLaborRefundOrderResponse {
    ...
    // 退回云账户个税
    private String refundBrokerPersonalTax;

    // 退回云账户增值税
    private String refundBrokerValueAddedTax;

    // 退回云账户附加税
    private String refundBrokerAdditionalTax;
    ...
    public void setRefundBrokerPersonalTax(String refundBrokerPersonalTax) {
        this.refundBrokerPersonalTax = refundBrokerPersonalTax;
    }

    public String getRefundBrokerPersonalTax() {
        return refundBrokerPersonalTax;
    }

    public void setRefundBrokerValueAddedTax(String refundBrokerValueAddedTax) {
        this.refundBrokerValueAddedTax = refundBrokerValueAddedTax;
    }

    public String getRefundBrokerValueAddedTax() {
        return refundBrokerValueAddedTax;
    }

    public void setRefundBrokerAdditionalTax(String refundBrokerAdditionalTax) {
        this.refundBrokerAdditionalTax = refundBrokerAdditionalTax;
    }

    public String getRefundBrokerAdditionalTax() {
        return refundBrokerAdditionalTax;
    }
    ...
    public String toString() {
        return "GetLaborRefundOrderResponse{" +
                ...
                ", refundBrokerPersonalTax='" + refundBrokerPersonalTax + '\'' +
                ", refundBrokerValueAddedTax='" + refundBrokerValueAddedTax + '\'' +
                ", refundBrokerAdditionalTax='" + refundBrokerAdditionalTax + '\'' +
